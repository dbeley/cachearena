 ...
 */
export function texts(nodes: NodeListOf<Node> | Node[] | null | undefined): string[] {
 ...
 */
export function toNumber(raw: string | null | undefined): string | number {
  if (!raw) return "";
 ...
 */
export function pickSrc(img: HTMLImageElement | null | undefined): string {
  if (!img) return "";
